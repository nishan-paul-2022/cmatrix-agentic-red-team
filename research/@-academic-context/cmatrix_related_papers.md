# CMatrix — Curated Research Paper Index
## LLM-Orchestrated Multi-Agent Autonomous Vulnerability Assessment & Penetration Testing
...
### 4. Co-RedTeam: Orchestrated Security Discovery and Exploitation with LLM Agents
...
### 5. CyberExplorer: Benchmarking LLM Offensive Security Capabilities in a Real-World Attacking Simulation
- **Venue:** 🟠 arXiv (Feb 2026)
...
### 6. To Defend Against Cyber Attacks, We Must Teach AI Agents to Hack
- **Venue:** 🟠 arXiv (Feb 2026)
...
### 7. PTFusion: LLM-driven Context-aware Knowledge Fusion for Web Penetration Testing
...
### 9. A Survey on the Unique Security of Autonomous and Collaborative LLM Agents
...
### 10. Towards Cybersecurity Superintelligence: from AI-guided humans to human-guided AI
...
### 11. A Survey of Agentic AI and Cybersecurity: Challenges, Opportunities and Use-case Prototypes
...
### 12. A Red Teaming Framework for Evaluating Robustness of AI-enabled Security Orchestration, Automation, and Response (SOAR) Systems
...
### 13. EnIGMA: Interactive Tools Substantially Assist LM Agents in Finding Security Vulnerabilities
- **Venue:** 🔴 ICLR 2025
...
### 15. Measuring and Augmenting Large Language Models for Solving Capture-the-Flag Challenges
- **Venue:** 🔴 ACM CCS 2025
...
### 16. PentestAgent: Incorporating LLM Agents to Automated Penetration Testing
- **Venue:** 🟡 AsiaCCS 2025
...
### 17. From Capabilities to Performance: Evaluating Key Functional Properties of LLM Architectures in Penetration Testing
- **Venue:** 🔴 ACL 2025
- **LLM4Pentest listing:** Confirmed CCF-A
...
### 18. Cloak, Honey, Trap: Proactive Defenses Against LLM Agents
...
### 19. A Unified Modeling Framework for Automated Penetration Testing
...
### 20. VulnBot: Autonomous Penetration Testing for a Multi-Agent Collaborative Framework
...
### 21. Incalmo: An Autonomous LLM-assisted System for Red Teaming Multi-Host Networks
...
### 22. CAI: An Open, Bug Bounty-Ready Cybersecurity AI
...
### 23. Cybersecurity AI: The World's Top AI Agent for Security CTF
...
### 24. Pentest-R1: Towards Autonomous Penetration Testing Reasoning Optimized via Two-Stage Reinforcement Learning
- **Venue:** 🟠 arXiv (Aug 2025)
- **arXiv:** [2508.07382](https://arxiv.org/abs/2508.07382)
- **Code:** [GitHub](https://github.com/KHenryAegis/Pentest-R1)
- **Why it matters for CMatrix:** Applies reinforcement learning (RL) to optimize pentest reasoning — directly validates CMatrix's choice of DeepSeek-R1 (chain-of-thought reasoning model). Two-stage RL training aligns with CMatrix's planned fine-tuning strategy.

---

### 25. RedTeamLLM: an Agentic AI Framework for Offensive Security
...
### 26. xOffense: An AI-driven Autonomous Penetration Testing Framework with Offensive Knowledge-enhanced LLMs and Multi-Agent Systems
...
### 27. D-CIPHER: Dynamic Collaborative Intelligent Multi-Agent System with Planner and Heterogeneous Executors for Offensive Security
...
### 28. RapidPen: Fully Automated IP-to-Shell Penetration Testing with LLM-based Agents
- **Venue:** 🟠 arXiv (Feb 2025)
...
### 29. ARACNE: An LLM-Based Autonomous Shell Pentesting Agent
- **Venue:** 🟠 arXiv (Feb 2025)
...
### 30. AutoPentest: Enhancing Vulnerability Management With Autonomous LLM Agents
...
### 31. RefPentester: A Knowledge-Informed Self-Reflective Penetration Testing Framework Based on Large Language Models
- **Venue:** 🟠 arXiv (May 2025)
...
### 32. CurriculumPT: LLM-Based Multi-Agent Autonomous Penetration Testing with Curriculum-Guided Task Scheduling
...
### 33. Automated Penetration Testing with LLM Agents and Classical Planning
- **Venue:** 🟠 arXiv (Dec 2025)
...
### 34. PentestEval: Benchmarking LLM-based Penetration Testing with Modular and Stage-Level Design
- **Venue:** 🟠 arXiv (Dec 2025)
- **arXiv:** [2512.14233](https://arxiv.org/abs/2512.14233)
- **Why it matters for CMatrix:** Stage-level modular benchmark design — exactly what CMatrix needs for evaluation. Defines metrics per pentest phase (recon, scan, exploit, report).

---

### 35. PentestMCP: LLM and MCP Based Multi-Agent Framework for Automated Penetration Testing
...
### 36. On the Surprising Efficacy of LLMs for Penetration-Testing
...
### 38. Forewarned is Forearmed: A Survey on LLM-based Agents in Autonomous Cyberattacks
- **Venue:** 🟠 arXiv (May 2025)
...
### 39. Shell or Nothing: Real-World Benchmarks and Memory-Activated Agents for Automated Penetration Testing
- **Venue:** 🟠 arXiv (2025)
- **Why it matters for CMatrix:** Memory-activated agent design for persistence across pentest sessions — maps directly to CMatrix's Qdrant vector memory architecture.
...
### 43. An Empirical Evaluation of LLMs for Solving Offensive Security Challenges
- **Venue:** 🔴 NeurIPS 2024
...
### 44. PentestGPT: Evaluating and Harnessing Large Language Models for Automated Penetration Testing
...
### 45. NYU CTF Bench: A Scalable Open-Source Benchmark Dataset for Evaluating LLMs in Offensive Security
- **Venue:** 🔴 NeurIPS 2024
...
### 46. Teams of LLM Agents Can Exploit Zero-Day Vulnerabilities
...
### 47. LLM Agents Can Autonomously Exploit One-Day Vulnerabilities
...
### 48. AutoAttacker: A Large Language Model Guided System to Implement Automatic Cyber-attacks
...
### 49. BreachSeek: A Multi-Agent Automated Penetration Tester
...
### 50. Cybench: A Framework for Evaluating Cybersecurity Capabilities and Risks of Language Models
...
### 51. HackSynth: LLM Agent and Evaluation Framework for Autonomous Penetration Testing
...
### 52. SoK: A Comparison of Autonomous Penetration Testing Agents
- **Venue:** 🟡 ARES 2024
...
### 53. AutoPT: How Far Are We from the End2End Automated Web Penetration Testing?
...
### 54. PENTEST-AI: An LLM-Powered Multi-Agents Framework for Penetration Testing Automation Leveraging MITRE ATT&CK
- **Venue:** 🟡 IEEE CSR 2024
...
### 55. PenHeal: A Two-Stage LLM Framework for Automated Pentesting and Optimal Remediation
...
### 56. Getting pwn'd by AI: Penetration Testing with Large Language Models
- **Venue:** 🔴 ESEC/FSE 2023
...
### 57. Language Agents as Hackers: Evaluating Cybersecurity Skills with Capture the Flag
...
## Additional High-Value Benchmarks & Datasets

| Paper | Venue | arXiv | Relevance |
|---|---|---|---|
| **CyberGym: Evaluating AI Agents' Real-World Cybersecurity Capabilities at Scale** | 🟠 arXiv 2025 | [link](https://arxiv.org/abs/2502.00000) | Scalable real-world eval for CMatrix |
| **CRAKEN: LLM Agent for CTF** | 🟠 arXiv 2025 | — | Multi-agent CTF system, CMatrix benchmark |
| **BountyBench: Bug Bounty Evaluation** | 🟠 arXiv 2025 | — | Real-world bounty task evaluation |
| **An Empirical Survey of CTF Environments** | 🟡 JNCA 2023 | [S1084804519303303](https://www.sciencedirect.com/science/article/abs/pii/S1084804519303303) | Lab setup reference for CMatrix |

---

## Reading Priority for CMatrix Research

### 🚨 Must-Read First (Core Architecture Validation)
1. PentestGPT (USENIX 2024) — *the* foundation paper
2. Teams of LLM Agents Can Exploit Zero-Day Vulnerabilities (2024) — multi-agent zero-day proof
3. VulnBot (2025) — closest architectural match
4. PentestAgent AsiaCCS (2025) — closest direct competitor
5. Co-RedTeam (2026, Google) — multi-agent orchestration state of the art

### 📖 Must-Read for Publication (Related Work Coverage)
6. SoK: Comparison of Autonomous Pentest Agents — systematic comparison
7. A Unified Modeling Framework for Automated Pentesting — C&S journal
8. Forewarned is Forearmed Survey (2025) — comprehensive survey
9. EnIGMA ICLR 2025 — tooling design
10. Cybench benchmark — evaluation standard

### 🔬 Must-Read for CMatrix Evaluation Design
11. NYU CTF Bench (NeurIPS 2024)
12. HackWorld (ICLR 2026)
13. CyberExplorer (2026)
14. PentestEval (2025)
15. Measuring and Augmenting LLMs for CTF (CCS 2025)

### 🧠 Must-Read for Model/Fine-tuning Strategy
16. Pentest-R1 (RL for pentest reasoning)
17. Cyber-Zero (training without runtime)
18. xOffense (Qwen3-32B fine-tuning)
19. From Capabilities to Performance (ACL 2025)

---

*Last updated: May 23, 2026. All papers verified against arXiv, ACM DL, USENIX, and IEEE Xplore.*
