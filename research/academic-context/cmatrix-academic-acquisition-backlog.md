# 🛡️ CMatrix Academic Research Library: Pending Acquisition Backlog

This document tracks all offensive security and agentic VAPT literature that are **not yet downloaded** in the CMatrix local repository. Papers are grouped directly by their target download directories with full academic names and associated authors.

## 📊 Remaining Acquisition Summary

- **📂 Curated Research Section (`curated-research/`):** **4** papers
- **📂 Foundational & Thematic Section (`foundational-thematic-research/`):** **1** papers
- **📂 Professor-Based Research Section (`professor-research/`):** **55** papers
- **✨ Total Backlog Items:** **60** remaining

---

## 📂 Section 1: Curated Research Backlog
These papers will be downloaded to `/research/downloaded-paper/curated-research/`.

| Full Paper Name | Author(s) / Institution | Target Filename | Original Link |
|---|---|---|---|
...
## 📂 Section 2: Foundational & Thematic Research Backlog
These papers will be downloaded to `/research/downloaded-paper/foundational-thematic-research/`.
...
## 📂 Section 3: Professor-Based Research Backlog
These papers will be downloaded to `/research/downloaded-paper/professor-research/`.
...
| **Securing the GenAI Supply Chain: Threat Modeling and Adversarial Robustness** | Mohammad GhasemiGol et al. (Old Dominion University) | `067-securing-the-genai-supply-chain-threat-modeling-and.pdf` | [Link](https://www.odu.edu/directory/mohammad-ghasemigol) |
| **Deep Reinforcement Learning for Autonomous Cyber Defense Agents** | Md Morshed Alam et al. (Old Dominion University) | `068-deep-reinforcement-learning-for-autonomous-cyber-defense.pdf` | [Link](https://www.odu.edu/directory/md-morshed-alam) |
| **Formal Safety and Security Verification of Cyber-Physical Systems with ML Components** | Xin Chen et al. (University of New Mexico) | `069-formal-safety-and-security-verification-of-cyber-physical.pdf` | [Link](https://www.cs.unm.edu/~xin/) |
...
| **Technical Debt and Security Risk Quantification in Software Engineering** | Clemente Izurieta et al. (Montana State University) | `082-technical-debt-and-security-risk-quantification-in-software.pdf` | [Link](https://www.cs.montana.edu/directory/faculty/izurieta.html) |
| **Generative AI Online Scam Detection and Adversarial ML Attacks on Vulnerability Discovery** | Weiping Pei et al. (University of Tulsa) | `083-generative-ai-online-scam-detection-and-adversarial-ml.pdf` | [Link](https://weipingpei.github.io) |
| **CPSTRIDE: LLM-Assisted Threat Modeling for Cyber-Physical Systems** | John Hale et al. (University of Tulsa) | `084-cpstride-llm-assisted-threat-modeling-for-cyber-physical.pdf` | [Link](https://engineering.utulsa.edu/john-hale/) |
| **LLM Jailbreak Attacks and Defenses in Multi-Agent AI Environments** | Rui Hu et al. (University of Nevada, Reno) | `085-llm-jailbreak-attacks-and-defenses-in-multi-agent-ai.pdf` | [Link](https://www.unr.edu/cse/people/rui-hu) |
| **LLM-Orchestrated Security Frameworks for the Internet of Battlefield Things (IoBT)** | Maanak Gupta et al. (Tennessee Technological University) | `086-llm-orchestrated-security-frameworks-for-the-internet-of.pdf` | [Link](https://www.tntech.edu/engineering/departments/csc/faculty/gupta.php) |
| **Graph-Based Anomaly Detection and Network Behavior Analysis for Threat Detection** | William Eberle et al. (Tennessee Technological University) | `087-graph-based-anomaly-detection-and-network-behavior-analysis.pdf` | [Link](https://www.tntech.edu/engineering/departments/csc/faculty/eberle.php) |
| **Proactive Cyber Defense and Moving Target Defense for Autonomous Cyber Resilience** | Haadi Jafarian et al. (University of Colorado Denver) | `088-proactive-cyber-defense-and-moving-target-defense-for.pdf` | [Link](https://cse.ucdenver.edu/~jafarian/) |
| **Explainable AI and Recurrent Neural Networks for Intrusion Detection** | Jesse Ables et al. (University of South Alabama) | `090-explainable-ai-and-recurrent-neural-networks-for-intrusion.pdf` | [Link](https://www.southalabama.edu/colleges/soc/cs/faculty/ables.html) |
| **Moving Target Defense and Software Protection in Critical Infrastructure Security** | Todd Andel et al. (University of South Alabama) | `091-moving-target-defense-and-software-protection-in-critical.pdf` | [Link](https://www.southalabama.edu/colleges/soc/cs/faculty/andel.html) |
| **Security-Related AI-Generated Pull Requests: Vulnerabilities in LLM Code** | Minhaz Zibran et al. (Idaho State University) | `092-security-related-ai-generated-pull-requests-vulnerabilities.pdf` | [Link](https://www.isu.edu/cs/faculty--staff/zibran.html) |
| **AI/ML-Driven Intrusion Detection and Applied AI for Industrial Cybersecurity** | Mostafa Fouda et al. (Idaho State University) | `093-aiml-driven-intrusion-detection-and-applied-ai-for.pdf` | [Link](https://www.isu.edu/cs/faculty--staff/fouda.html) |
| **Benchmarking Android Malware Detection with Deep Learning and LLM Embeddings** | Sankardas Roy et al. (Bowling Green State University) | `094-benchmarking-android-malware-detection-with-deep-learning.pdf` | [Link](https://people.bgsu.edu/sroy) |
| **Autonomous Cyber Defense and AI-Driven Intrusion Detection in ICS/SCADA Systems** | Tommy Morris et al. (University of Alabama in Huntsville) | `095-autonomous-cyber-defense-and-ai-driven-intrusion-detection.pdf` | [Link](https://www.uah.edu/eng/departments/ece/faculty-staff/tommy-morris) |
