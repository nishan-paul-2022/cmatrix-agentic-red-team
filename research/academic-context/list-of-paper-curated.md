...
### 14. AWE: Adaptive Agents for Dynamic Web Penetration Testing
- **Venue:** 🔴 NDSS 2026
...
### 15. PACEbench: A Framework for Evaluating Practical AI Cyber-Exploitation Capabilities
- **Venue:** 🔴 ICLR 2026
...
### 16. EnIGMA: Interactive Tools Substantially Assist LM Agents in Finding Security Vulnerabilities
- **Venue:** 🔴 ICLR 2025
...
### 18. Measuring and Augmenting Large Language Models for Solving Capture-the-Flag Challenges
- **Venue:** 🔴 ACM CCS 2025
...
### 19. PentestAgent: Incorporating LLM Agents to Automated Penetration Testing
- **Venue:** 🟡 AsiaCCS 2025
...
### 20. From Capabilities to Performance: Evaluating Key Functional Properties of LLM Architectures in Penetration Testing
- **Venue:** 🔴 ACL 2025
...
### 21. Cloak, Honey, Trap: Proactive Defenses Against LLM Agents
...
### 22. A Unified Modeling Framework for Automated Penetration Testing
...
### 23. VulnBot: Autonomous Penetration Testing for a Multi-Agent Collaborative Framework
...
### 24. Incalmo: An Autonomous LLM-assisted System for Red Teaming Multi-Host Networks
...
### 25. CAI: An Open, Bug Bounty-Ready Cybersecurity AI
...
### 26. Cybersecurity AI: The World's Top AI Agent for Security CTF
...
### 27. Pentest-R1: Towards Autonomous Penetration Testing Reasoning Optimized via Two-Stage Reinforcement Learning
...
### 28. RedTeamLLM: an Agentic AI Framework for Offensive Security
...
### 29. xOffense: An AI-driven Autonomous Penetration Testing Framework with Offensive Knowledge-enhanced LLMs and Multi-Agent Systems
...
### 30. D-CIPHER: Dynamic Collaborative Intelligent Multi-Agent System with Planner and Heterogeneous Executors for Offensive Security
...
### 31. AutoPentester: An LLM Agent-based Framework for Automated Penetration Testing
...
### 32. RapidPen: Fully Automated IP-to-Shell Penetration Testing with LLM-based Agents
- **Venue:** 🟠 arXiv (Feb 2025)
...
### 33. ARACNE: An LLM-Based Autonomous Shell Pentesting Agent
- **Venue:** 🟠 arXiv (Feb 2025)
...
### 34. AutoPentest: Enhancing Vulnerability Management With Autonomous LLM Agents
...
### 35. RefPentester: A Knowledge-Informed Self-Reflective Penetration Testing Framework Based on Large Language Models
- **Venue:** 🟠 arXiv (May 2025)
...
### 36. CurriculumPT: LLM-Based Multi-Agent Autonomous Penetration Testing with Curriculum-Guided Task Scheduling
...
### 37. Automated Penetration Testing with LLM Agents and Classical Planning
- **Venue:** 🟠 arXiv (Dec 2025)
...
### 38. PentestMCP: LLM and MCP Based Multi-Agent Framework for Automated Penetration Testing
...
### 39. On the Surprising Efficacy of LLMs for Penetration-Testing
...
### 40. Multi-Agent Penetration Testing AI for the Web
- **Venue:** 🟠 arXiv (Aug 2025)
...
### 41. Forewarned is Forearmed: A Survey on LLM-based Agents in Autonomous Cyberattacks
- **Venue:** 🟠 arXiv (May 2025)
...
### 42. AI-Augmented SOC: A Survey of LLMs and Agents for Security Automation
...
### 43. Towards Automated Penetration Testing: Introducing LLM Benchmark, Analysis, and Improvements
- **Venue:** 🟠 UMAP 2025
...
### 44. Cybersecurity AI: A Game-Theoretic AI for Guiding Attack and Defense
- **Venue:** 🟠 arXiv (Jan 2026)
...
### 45. BountyBench: Dollar Impact of AI Agent Attackers and Defenders on Real-World Cybersecurity Systems
...
### 46. CRAKEN: Cybersecurity LLM Agent with Knowledge-Based Execution
...
### 47. CyberGym: Evaluating AI Agents' Real-World Cybersecurity Capabilities at Scale
...
### 48. An Empirical Evaluation of LLMs for Solving Offensive Security Challenges
- **Venue:** 🔴 NeurIPS 2024
...
### 49. Shell or Nothing: Real-World Benchmarks and Memory-Activated Agents for Automated Penetration Testing
- **Venue:** 🟠 arXiv (2025)
...
### 50. Perry: A High-level Framework for Accelerating Cyber Deception Experimentation
...
### 51. PentestEval: Benchmarking LLM-based Penetration Testing with Modular and Stage-Level Design
- **Venue:** 🟠 arXiv (Dec 2025)
- **arXiv:** [2512.14233](https://arxiv.org/abs/2512.14233)
...
### 63. PenHeal: A Two-Stage LLM Framework for Automated Pentesting and Optimal Remediation
...
### 65. Language Agents as Hackers: Evaluating Cybersecurity Skills with Capture the Flag
...
### 66. Using Large Language Models for Cybersecurity Capture-The-Flag Challenges and Certification Questions
