...
### 13. ExploitGym: Can AI Agents Turn Security Vulnerabilities into Real Attacks?
- **Venue:** 🟠 arXiv (May 2026)
...
### 15. AWE: Adaptive Agents for Dynamic Web Penetration Testing
- **Venue:** 🔴 NDSS 2026
...
### 16. PACEbench: A Framework for Evaluating Practical AI Cyber-Exploitation Capabilities
- **Venue:** 🔴 ICLR 2026
...
### 17. EnIGMA: Interactive Tools Substantially Assist LM Agents in Finding Security Vulnerabilities
- **Venue:** 🔴 ICLR 2025
...
### 18. Can LLMs Hack Enterprise Networks? Autonomous Assumed Breach Penetration-Testing Active Directory Networks
...
### 19. Measuring and Augmenting Large Language Models for Solving Capture-the-Flag Challenges
- **Venue:** 🔴 ACM CCS 2025
...
### 20. PentestAgent: Incorporating LLM Agents to Automated Penetration Testing
- **Venue:** 🟡 AsiaCCS 2025
...
### 21. From Capabilities to Performance: Evaluating Key Functional Properties of LLM Architectures in Penetration Testing
- **Venue:** 🔴 ACL 2025
...
### 22. Cloak, Honey, Trap: Proactive Defenses Against LLM Agents
...
### 23. A Unified Modeling Framework for Automated Penetration Testing
...
### 24. VulnBot: Autonomous Penetration Testing for a Multi-Agent Collaborative Framework
...
### 25. Incalmo: An Autonomous LLM-assisted System for Red Teaming Multi-Host Networks
...
### 26. CAI: An Open, Bug Bounty-Ready Cybersecurity AI
...
### 27. Cybersecurity AI: The World's Top AI Agent for Security CTF
...
### 28. Pentest-R1: Towards Autonomous Penetration Testing Reasoning Optimized via Two-Stage Reinforcement Learning
...
### 29. RedTeamLLM: an Agentic AI Framework for Offensive Security
...
### 30. xOffense: An AI-driven Autonomous Penetration Testing Framework with Offensive Knowledge-enhanced LLMs and Multi-Agent Systems
...
### 31. D-CIPHER: Dynamic Collaborative Intelligent Multi-Agent System with Planner and Heterogeneous Executors for Offensive Security
...
### 32. AutoPentester: An LLM Agent-based Framework for Automated Penetration Testing
...
### 33. RapidPen: Fully Automated IP-to-Shell Penetration Testing with LLM-based Agents
- **Venue:** 🟠 arXiv (Feb 2025)
...
### 34. ARACNE: An LLM-Based Autonomous Shell Pentesting Agent
- **Venue:** 🟠 arXiv (Feb 2025)
...
### 35. AutoPentest: Enhancing Vulnerability Management With Autonomous LLM Agents
...
### 36. RefPentester: A Knowledge-Informed Self-Reflective Penetration Testing Framework Based on Large Language Models
- **Venue:** 🟠 arXiv (May 2025)
...
### 37. CurriculumPT: LLM-Based Multi-Agent Autonomous Penetration Testing with Curriculum-Guided Task Scheduling
...
### 38. Automated Penetration Testing with LLM Agents and Classical Planning
- **Venue:** 🟠 arXiv (Dec 2025)
...
### 39. PentestMCP: LLM and MCP Based Multi-Agent Framework for Automated Penetration Testing
...
### 40. On the Surprising Efficacy of LLMs for Penetration-Testing
...
### 41. Multi-Agent Penetration Testing AI for the Web
- **Venue:** 🟠 arXiv (Aug 2025)
...
### 42. Forewarned is Forearmed: A Survey on LLM-based Agents in Autonomous Cyberattacks
- **Venue:** 🟠 arXiv (May 2025)
...
### 43. AI-Augmented SOC: A Survey of LLMs and Agents for Security Automation
...
### 44. Towards Automated Penetration Testing: Introducing LLM Benchmark, Analysis, and Improvements
- **Venue:** 🟠 UMAP 2025
...
### 45. Cybersecurity AI: A Game-Theoretic AI for Guiding Attack and Defense
- **Venue:** 🟠 arXiv (Jan 2026)
...
### 46. BountyBench: Dollar Impact of AI Agent Attackers and Defenders on Real-World Cybersecurity Systems
...
### 47. CRAKEN: Cybersecurity LLM Agent with Knowledge-Based Execution
...
### 48. CyberGym: Evaluating AI Agents' Real-World Cybersecurity Capabilities at Scale
...
### 49. An Empirical Evaluation of LLMs for Solving Offensive Security Challenges
- **Venue:** 🔴 NeurIPS 2024
...
### 50. Shell or Nothing: Real-World Benchmarks and Memory-Activated Agents for Automated Penetration Testing
- **Venue:** 🟠 arXiv (2025)
...
### 51. Perry: A High-level Framework for Accelerating Cyber Deception Experimentation
...
### 52. PentestEval: Benchmarking LLM-based Penetration Testing with Modular and Stage-Level Design
- **Venue:** 🟠 arXiv (Dec 2025)
- **arXiv:** [2512.14233](https://arxiv.org/abs/2512.14233)
...
### 53. PentestGPT: Evaluating and Harnessing Large Language Models for Automated Penetration Testing
...
### 54. NYU CTF Bench: A Scalable Open-Source Benchmark Dataset for Evaluating LLMs in Offensive Security
- **Venue:** 🔴 NeurIPS 2024
...
### 55. Teams of LLM Agents Can Exploit Zero-Day Vulnerabilities
...
### 56. LLM Agents Can Autonomously Exploit One-Day Vulnerabilities
...
### 57. AutoAttacker: A Large Language Model Guided System to Implement Automatic Cyber-attacks
...
### 58. BreachSeek: A Multi-Agent Automated Penetration Tester
...
### 59. Cybench: A Framework for Evaluating Cybersecurity Capabilities and Risks of Language Models
...
### 60. HackSynth: LLM Agent and Evaluation Framework for Autonomous Penetration Testing
...
### 61. SoK: A Comparison of Autonomous Penetration Testing Agents
- **Venue:** 🟡 ARES 2024
...
### 62. AutoPT: How Far Are We from the End2End Automated Web Penetration Testing?
...
### 63. PENTEST-AI: An LLM-Powered Multi-Agents Framework for Penetration Testing Automation Leveraging MITRE ATT&CK
- **Venue:** 🟡 IEEE CSR 2024
...
### 64. NYU CTF Bench: A Scalable Open-Source Benchmark Dataset for Evaluating LLMs in Offensive Security
- **Venue:** 🔴 NeurIPS 2024
- **URL:** [NeurIPS](https://proceedings.neurips.cc/paper_files/paper/2024/hash/69d97a6493fbf016fff0a751f253ad18-Abstract-Datasets_and_Benchmarks_Track.html)
- **Code:** [GitHub](https://github.com/NYU-LLM-CTF/NYUCTFBench)
...
### 65. PenHeal: A Two-Stage LLM Framework for Automated Pentesting and Optimal Remediation
...
### 66. Getting pwn'd by AI: Penetration Testing with Large Language Models
- **Venue:** 🔴 ESEC/FSE 2023
...
### 67. Language Agents as Hackers: Evaluating Cybersecurity Skills with Capture the Flag
...
### 68. Using Large Language Models for Cybersecurity Capture-The-Flag Challenges and Certification Questions
