...
|------|--------------|-------------------|--------|
| [`01-red-teaming.md`](./paper-02-red-teaming/01-red-teaming.md) | AI-Driven Agentic Red Teaming | USENIX Security 2026 | 4–6 months |
| [`02-hitl-safety.md`](./paper-03-hitl-safety/02-hitl-safety.md) | HITL Safety for Security Agents | SOUPS 2026 | 3–4 months |
| [`03-agent-reasoning.md`](./paper-04-agent-reasoning/03-agent-reasoning.md) | ToT + ReWOO + Self-Reflection in Security | ACM CCS 2026 | 4–5 months |
| [`04-vulnerability-intelligence.md`](./paper-05-vulnerability-intelligence/04-vulnerability-intelligence.md) | Agentic RAG for CVE Intelligence | ACM SIGIR 2026 | 4–5 months |
...
**File**: [`01-red-teaming.md`](./paper-02-red-teaming/01-red-teaming.md)
...
**File**: [`02-hitl-safety.md`](./paper-03-hitl-safety/02-hitl-safety.md)
...
**File**: [`03-agent-reasoning.md`](./paper-04-agent-reasoning/03-agent-reasoning.md)
...
**File**: [`04-vulnerability-intelligence.md`](./paper-05-vulnerability-intelligence/04-vulnerability-intelligence.md)
