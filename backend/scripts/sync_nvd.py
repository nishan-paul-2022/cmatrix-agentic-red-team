...
async def main():
    ...
    parser.add_argument('--full', action='store_true', help='Perform full sync (WARNING: Takes hours)')
    parser.add_argument('--days', type=int, default=7, help='Days to look back for incremental sync')
