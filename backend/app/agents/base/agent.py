    ...
    def _reason(self, state: SubgraphState) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "metadata": {
                    **state.get("metadata", {}),
                    "reasoning_iterations": state.get("metadata", {}).get("reasoning_iterations", 0) + 1
                }
            }
    ...
    def _execute_tools(self, state: SubgraphState) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "metadata": {
                    **state.get("metadata", {}),
                    "tools_executed": state.get("metadata", {}).get("tools_executed", 0) + len(tool_calls)
                }
            }
