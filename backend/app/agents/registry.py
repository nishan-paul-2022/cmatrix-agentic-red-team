...
class AgentRegistry:
    ...
    AGENT_KEYWORDS = {
        NETWORK_AGENT: [
            "port", "scan", "network", "nmap", "service", "host",
            "tcp", "udp", "ping", "traceroute", "netstat", "firewall"
        ],
        WEB_AGENT: [
            "web", "http", "https", "ssl", "tls", "website", "url",
            "header", "cookie", "session", "xss", "csrf", "owasp"
        ],
        VULN_INTEL_AGENT: [
    ...
    def get_agent_info(self, agent_type: str) -> Dict:
        ...
        info = {
            ...
            self.WEB_AGENT: {
                ...
                "capabilities": ["Web app scanning", "SSL/TLS testing", "Security header validation"],
