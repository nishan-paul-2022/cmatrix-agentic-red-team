...
- `paper-research/paper-04-agent-reasoning/main.tex`: Master file.
- `paper-research/paper-04-agent-reasoning/assets/equations.tex`: Consolidated equations.
- `paper-research/paper-04-agent-reasoning/assets/references.bib`: BibTeX source.
