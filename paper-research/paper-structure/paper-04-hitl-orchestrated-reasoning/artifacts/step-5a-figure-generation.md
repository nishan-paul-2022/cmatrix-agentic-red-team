...
- `paper-research/paper-04-agent-reasoning/assets/figure-03-reasoning-flow.tex`: Reasoning loop.
- `paper-research/paper-04-agent-reasoning/assets/figure-04-performance-chart.tex`: Success rate chart.
- `paper-research/paper-04-agent-reasoning/assets/figure-05-efficiency-chart.tex`: Token efficiency chart.
- `paper-research/paper-04-agent-reasoning/assets/ASSET-INDEX.md`: Updated index.
