...
- `paper-research/paper-04-agent-reasoning/content/abstract.tex`: Abstract source.
- `paper-research/paper-04-agent-reasoning/content/introduction.tex`: Introduction source.
