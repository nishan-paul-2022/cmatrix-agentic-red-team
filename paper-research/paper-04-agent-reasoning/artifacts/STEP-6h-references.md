...
- `paper-research/paper-04-agent-reasoning/content/references.bib`: Finalized BibTeX source.
- `paper-research/paper-04-agent-reasoning/assets/ASSET-INDEX.md`: Updated.
