...
- `paper-research/paper-04-agent-reasoning/content/threat_model.tex`: Formal threat model.
- `paper-research/paper-04-agent-reasoning/content/methodology.tex`: Expanded methodology.
