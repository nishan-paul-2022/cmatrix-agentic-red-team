...
|**Kill-Chain**|Recon|Initial Access|Exploit|Auth Bypass|Privilege Escalation<br>Code Execution|Persistence|(_≥_2 chain|)<br>(_≥_3 chain)|
|---|---|---|---|---|---|---|---|---|
...
- [2] Alsharif Abuadbba, Chris Hicks, Kristen Moore, Vasilios Mavroudis, Burak Hasircioglu, Diksha Goel, and Piers Jennings. From promise to peril: Rethinking cybersecurity red and blue teaming in the age of llms. _
...
- [5] Mohamed Amine Ferrag, Norbert Tihanyi, and Merouane Debbah. From llm reasoning to autonomous ai agents: A comprehensive review. _
...
- [9] Andreas Happe and Jürgen Cito. Benchmarking practices in llm-driven offensive security: Testbeds, metrics, and experiment design. _
...
- [12] Yue Li, Xiao Li, Hao Wu, Minghui Xu, Yue Zhang, Xiuzhen Cheng, Fengyuan Xu, and Sheng Zhong. Everything you wanted to know about llm-based vulnerability detection but were afraid to ask. _
...
- [14] Lajos Muzsai, David Imolai, and András Lukács. Hacksynth: Llm agent and evaluation framework for autonomous penetration testing. _
...
- [18] Nanda Rani and Sandeep Kumar Shukla. Aura: A multi-agent intelligence framework for knowledge-enhanced cyber threat attribution. _
...
- [20] Bikash Saha and Sandeep Kumar Shukla. Malgen: A generative agent framework for modeling malicious software in cybersecurity. _

- [21] Minghao Shao, Boyuan Chen, Sofija Jancheska, Brendan Dolan-Gavitt, Siddharth Garg, Ramesh Karri, and Muhammad Shafique. An empirical evaluation of llms for solving offensive security challenges. _
...
- [23] Minghao Shao, Nanda Rani, Kimberly Milner, Haoran Xi, Meet Udeshi, Saksham Aggarwal, Venkata Sai Charan Putrevu, Sandeep Kumar Shukla, Prashanth Krishnamurthy, Farshad Khorrami, et al. Towards effective offensive security llm agents: Hyperparameter tuning, llm as a judge, and a lightweight ctf benchmark. _

- [24] Minghao Shao, Haoran Xi, Nanda Rani, Meet Udeshi, Venkata Sai Charan Putrevu, Kimberly Milner, Brendan Dolan-Gavitt, Sandeep Kumar Shukla, Prashanth Krishnamurthy, Farshad Khorrami, et al. Craken: Cybersecurity llm agent with knowledge-based execution. _
...
- [29] Rustem Turtayev, Artem Petrov, Dmitrii Volkov, and Denis Volk. Hacking ctfs with plain agents. _

- [30] Meet Udeshi, Minghao Shao, Haoran Xi, Nanda Rani, Kimberly Milner, Venkata Sai Charan Putrevu, Brendan Dolan-Gavitt, Sandeep Kumar Shukla, Prashanth Krishnamurthy, Farshad Khorrami, et al. D-cipher: Dynamic collaborative intelligent multi-agent system with planner and heterogeneous executors for offensive security. _

- [31] Haoran Xi, Minghao Shao, Brendan Dolan-Gavitt, Muhammad Shafique, and Ramesh Karri. From trace to line: Llm agent for real-world oss vulnerability localization. _

- [32] Andy K Zhang, Neil Perry, Riya Dulepet, Joey Ji, Celeste Menders, Justin W Lin, Eliot Jones, Gashon Hussein, Samantha Liu, Donovan Jasper, et al. Cybench: A framework for evaluating cybersecurity capabilities and risks of language models. _
...
|---|---|---|---|---|---|
|**# Nodes**|497|599|169|1569|362<br>120|
|**# Edges**|416|537|109|1529|164<br>44|
|Port 7640|Port 8067|Port 9811|Port 3570<br>Port 7610|Port 8020| |||Port 7660<br>Port 8050<br>Port 7640|
|(a) Claude <br>graph|Opus 4.5|reasoning|(b) Claude Sonnet 4<br>graph|reasoning|(c) Gemini3 Pro reasoning graph |||Port 10000<br>Port 3700<br>Port 7640|
...
- , |✅🛑 Identified:Identified:  Blacklist fil er Blacklis t Constraint:  Newlines<br>ST UCK - ask CriticUCK - Budget Warn ✅ Identified:  require quotes (%27)<br>AGENT 5: SOLVER<br>CRITIC @ 80%<br>Try Bypasses: ✅ Inherited:  21 fails +<br>Backticks+IFS, Wildcard Idea<br>Subshell Payload:
- /bin/c?t /fl*
...
|3|$0.32|4|0|3 (High, Med, Med)|5|STUCK|Identifed bypass vec- |||||tors|
|4|$0.28|4|0|2 (High, Med)|5|STUCK|Exhausted<br>common |||||bypasses|
