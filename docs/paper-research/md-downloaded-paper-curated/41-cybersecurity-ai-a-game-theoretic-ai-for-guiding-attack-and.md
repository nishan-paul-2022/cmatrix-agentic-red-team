...
|---|---|---|---|
|**NodeID**|**Probabilit**|||
||**y**|5<br>1_→_2_→_4_→_7_→_9|0.673528|
|8|0.673528|||
|4|0.326472|1<br>1_→_2_→_3_→_6_→_8_→_9|0.326472 3<br>1_→_2_→_4_→_7|0.000000|
|2|0.000000|||
|3|0.000000|2<br>1_→_2_→_4|0.000000 4<br>1_→_2_→_4_→_7_→_8_→_9|0.000000|
...
|**Human**|10|2|–|–|
|`gpt-4o`|14|2|✓|Comprehensive. Covers all key details, includ-<br>ing trial–and–error and fnal PoC. Maintains co- ||herent fow with well–connected steps.|
...
|**Domain**|**LLM Model**|_t_**Attack Graph** (s)|_t_**CTR** (s)|_t_**total** (s)|**Cost ($)**|_tratio_|_cratio_|
|---|---|---|---|---|---|---|---|
...
- [10] Víctor Mayoral-Vilches. Cybersecurity ai: The dangerous gap between automation and autonomy. _
...
- [12] Víctor Mayoral-Vilches and Per Mannermaa Rynning. Cybersecurity ai: Hacking the ai hackers via prompt injection. _

- [13] Víctor Mayoral-Vilches. Cybersecurity ai: Humanoid robots as attack vectors. _

- [14] Víctor Mayoral-Vilches. The cybersecurity of a humanoid robot. _

- [15] Francesco Balassone, Víctor Mayoral-Vilches, Stefan Rass, Martin Pinzger, Gaetano Perrone, Simon Pietro Romano, and Peter Schartner. Cybersecurity ai: Evaluating agentic cybersecurity in attack/defense ctfs. _

- [16] Benlong Wu, Guoqiang Chen, Kejiang Chen, Xiuwei Shang, Jiapeng Han, Yanru He, Weiming Zhang, and Nenghai Yu. Autopt: How far are we from the end2end automated web penetration testing? _
...
|---|---|---|---|---|
|**Node ID**|**Probability**||| 1|1_→_4_→_6|1.000000|
...
|5|0.000000|2|1_→_5_→_6|0.000000 3|1_→_4_→_8|0.000000|
...
|DefenseStra|tegy|8|1_→_7_→_8|0.000000 9|1_→_8|0.000000|
...
|2|0.000000|3|1_→_2_→_3_→_6|0.000000 4|1_→_2_→_3_→_7|0.000000|
...
|4|0.500000|3|1_→_2_→_3_→_4_→_6|0.000000 4|1_→_2_→_3_→_4_→_7|0.000000|
