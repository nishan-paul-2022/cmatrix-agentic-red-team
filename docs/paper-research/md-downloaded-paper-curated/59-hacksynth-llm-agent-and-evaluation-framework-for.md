...
- [8] G. Deng, Y. Liu, V. Mayoral-Vilches, P. Liu, Y. Li, Y. Xu, T. Zhang, Y. Liu, M. Pinzger, and S. Rass, “PentestGPT: An ŁŁM-empowered automatic penetration testing tool,” _
...
- [11] T. Abramovich, M. Udeshi, M. Shao, K. Lieret, H. Xi, K. Milner, S. Jancheska, J. Yang, C. E. Jimenez, F. Khorrami _et al._ , “EniGMA: Enhanced interactive generative model agent for CTF challenges,” _
...
- [24] F. N. Motlagh, M. Hajizadeh, M. Majd, P. Najafi, F. Cheng, and C. Meinel, “Large language models in cybersecurity: State-of-theart,” _
...
- [26] Y. Zhang, W. Song, Z. Ji, N. Meng _et al._ , “How well does LLM generate security tests?” _

- [27] D. Noever, “Can large language models find and fix vulnerable software?” _
...
- [32] F. Heiding, B. Schneier, A. Vishwanath, J. Bernstein, and P. S. Park, “Devising and detecting phishing: Large language models vs. smaller human models,” _
...
- [34] P. V. Falade, “Decoding the Threat Landscape : ChatGPT, FraudGPT, and WormGPT in Social Engineering Attacks,” _

- [35] Z. Xi, W. Chen, X. Guo, W. He, Y. Ding, B. Hong, M. Zhang, J. Wang, S. Jin, E. Zhou _et al._ , “The rise and potential of large language model based agents: A survey,” _
...
- [44] J. Yang, C. E. Jimenez, A. Wettig, K. Lieret, S. Yao, K. Narasimhan, and O. Press, “Swe-agent: Agent-computer interfaces enable automated software engineering,” _
...
- [47] R. Fang, R. Bindu, A. Gupta, Q. Zhan, and D. Kang, “LLM agents can autonomously hack websites,” _

- [48] A. K. Zhang, N. Perry, R. Dulepet, E. Jones, J. W. Lin, J. Ji, C. Menders, G. Hussein, S. Liu, D. Jasper _et al._ , “Cybench: A framework for evaluating cybersecurity capabilities and risk of language models,” _

- [49] M. Shao, S. Jancheska, M. Udeshi, B. Dolan-Gavitt, H. Xi, K. Milner, B. Chen, M. Yin, S. Garg, P. Krishnamurthy _et al._ , “NYU CTF Dataset: A scalable open-source benchmark dataset for evaluating llms in offensive security,” _

- [50] A. Dubey, A. Jauhri, A. Pandey, A. Kadian, A. Al-Dahle, A. Letman, A. Mathur, A. Schelten, A. Yang, A. Fan _et al._ , “The Llama 3 herd of models,” _

- [51] M. Abdin, S. A. Jacobs, A. A. Awan, J. Aneja, A. Awadallah, H. Awadalla, N. Bach, A. Bahree, A. Bakhtiari, H. Behl _et al._ , “Phi-3 technical report: A highly capable language model locally on your phone,” _

- [52] H. Chen and N. Ding, “Probing the creativity of large language models: Can models produce divergent semantic association?” _
...
- [54] A. Holtzman, J. Buys, L. Du, M. Forbes, and Y. Choi, “The curious case of neural text degeneration,” _
...
- [56] J. Achiam, S. Adler, S. Agarwal, L. Ahmad, I. Akkaya, F. L. Aleman, D. Almeida, J. Altenschmidt, S. Altman, S. Anadkat _et al._ , “GPT-4 technical report,” _

- [57] A. Yang, B. Yang, B. Hui, B. Zheng, B. Yu, C. Zhou, C. Li, C. Li, D. Liu, F. Huang _et al._ , “Qwen2 technical report,” _

- [58] A. Q. Jiang, A. Sablayrolles, A. Roux, A. Mensch, B. Savary, C. Bamford, D. S. Chaplot, D. d. l. Casas, E. B. Hanna, F. Bressand _et al._ , “Mixtral of experts,” _

- [59] A. Hurst, A. Lerer, A. P. Goucher, A. Perelman, A. Ramesh, A. Clark, A. Ostrow, A. Welihinda, A. Hayes, A. Radford _et al._ , “Gpt-4o system card,” _
