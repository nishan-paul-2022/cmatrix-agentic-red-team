...
Every re-plan has a **formal, inspectable cause** — a specific graph event. This is what makes CMatrix's re-planning reliable and auditable. You can look at the engagement trajectory (covered at the end of this module) and see *exactly why* the Commander changed course at any point.
...
This targeted intervention is far more useful than blind retry number four. The Reflector is like a coach who steps in and says: "I've watched you struggle — here's what I see and what to try."
...
|--------|------|----------------|
| 01 | module-01-what-is-cmatrix.md | What CMatrix is, VAPT, AI agents, the 3 core problems, dual-graph answer |
| 02 | module-02-dual-graph-world-model.md | ASG + APG in full depth + visual diagram |
| 03 | module-03-agent-architecture.md | All 7 agents + system architecture diagram + spawn lifecycle diagram |
| 04 | module-04-tool-adapter-risk-gate.md | Tool Adapter, Risk Gate + visual decision tree |
| 05 | module-05-vapt-tools.md | All 11 VAPT tools — real-world + CMatrix usage |
| 06 | module-06-planning-cycle-and-learning.md | Planning cycle + visual loop diagram |
| 07 | module-07-methodology-contributions-related-work.md | Contributions, methodology, related work + shopvault.io walkthrough |
