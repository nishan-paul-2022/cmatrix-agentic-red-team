...
### Core
- `backend/.env` - EMBEDDING_MODEL config
- `backend/app/core/config.py` - Default settings
- `backend/app/services/vector_store.py` - All features
- `backend/app/tools/memory.py` - Enhanced tools
- `backend/app/services/orchestrator.py` - Metadata extraction

### Migration
- `backend/migrate_embeddings.py` - Collection migration (768d)
